 ...
 <!-- DataTales Example -->
        ...
        <i class="fa fa-plus fa-sm"></i> Tambah Jabatan</button>
        </button>
        </div>
      ...
      foreach ($jabatan as $row) : ?>
        <tr>
            ...
            <td class="text-center">
                <a href="<?=base_url(); ?>admin/jabatan/edit/<?= $row->id_jabatan; ?>" 
                class="badge badge-pill badge-warning"><i class="fa fa-edit"></i> Edit</a>
                <a href="<?=base_url(); ?>admin/jabatan/hapus/<?= $row->id_jabatan; ?>"
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <form method="post" enctype="multipart/form-data" action="<?=base_url() .'admin/jabatan/tambah_aksi'; ?>">
            <div class="modal-body">
                    <div class="form-group">
                        <label>Jabatan</label>
                        <input type="text" class="form-control" id="jabatan" name="jabatan"
                        required oninvalid="this.setCustomValidity('jabatan harus diisi!')" oninput="setCustomValidity('')">
                    </div>   
