 ...
 <!-- DataTales Example -->
    ...
    <tbody">
      <?php
      $no=1;
      foreach ($thn_ajrn as $row) : ?>
        <tr>
            <td><?= $no++; ?></td>
            <td><?= $row->thn_ajrn; ?></td>
            <td class="text-center">
                <a href="<?=base_url(); ?>admin/tahun_ajaran/edit/<?= $row->id_thn_ajrn; ?>" 
                class="badge badge-pill badge-warning"><i class="fa fa-edit"></i> Edit</a>
                <a href="<?=base_url(); ?>admin/tahun_ajaran/hapus/<?= $row->id_thn_ajrn; ?>"
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <form method="post" action="<?=base_url() .'admin/tahun_ajaran/tambah_aksi'; ?>">
            <div class="modal-body">
                      <div class="form-group">
                        <label>Tahun Ajaran</label>
                        <input type="text" class="form-control" id="thn_ajrn" name="thn_ajrn" 
                        required oninvalid="this.setCustomValidity('Tahun Ajaran harus diisi!')" oninput="setCustomValidity('')">
                    </div>   
