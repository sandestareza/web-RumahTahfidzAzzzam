            ...
            <div class="col-lg-8">
              <form action="<?=base_url('user/gantipassword')?>" method="post">
                    <div class="form-group">
                            ...
                            <input type="password" class="form-control" id="old_pass" name="old_pass" placeholder="Masukan password lama anda">
                            <?= form_error('old_pass','<small class="text-danger pl-3">', '</small>');?>
                    </div><br>
                    <div class="form-group">
                            <label>Password Baru</label>
                            <input type="password" class="form-control" id="new_pass" name="new_pass" placeholder="Masukan password baru anda">
                            <?= form_error('new_pass','<small class="text-danger pl-3">', '</small>');?>
                    </div>
                    <div class="form-group">
                            <label>Konfrimasi Password</label>
                            <input type="password" class="form-control" id="new_pass1" name="new_pass1" placeholder="Ulangi password baru anda">
